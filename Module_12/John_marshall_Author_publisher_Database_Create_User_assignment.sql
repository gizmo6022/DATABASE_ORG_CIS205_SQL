--john marshall 
--Assignment: Data Control Language (DCL) - Write CREATE USER Statements for the Publisher -Author - Books - Marketing: Database
--summer 2 2023
...
--Create User Statemnets----
--___________________________________________________________________

--Create User JIM
DROP USER IF EXISTS Jim;
CREATE USER Jim
IDENTIFIED BY "wordPass1!" ;
grant all privileges on AuthorPublisher_DB.* to Jim;


--Create User Selina
DROP USER IF EXISTS Selina;
CREATE USER Selina
IDENTIFIED BY "Friend123!";
grant all privileges on AuthorPublisher_DB.* to Selina;
