--john marshall 
--Homework Assignment: DELETE Statements for the Homework Assignment: Publisher -Author - Books - Marketing: Database
--summer 2 2023
...
(
    ...
    CONSTRAINT Contracts_FK1 FOREIGN KEY (aEmail_FK) REFERENCES Author(aEmail)  ON DELETE CASCADE,
    CONSTRAINT Contracts_FK2 FOREIGN KEY (pEmail_FK) REFERENCES Publisher(pEmail)  ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT Books_FK1 FOREIGN KEY (aEmail_FK) REFERENCES Author(aEmail)  ON DELETE CASCADE,
    CONSTRAINT Books_FK2 FOREIGN KEY (pEmail_FK) REFERENCES Publisher(pEmail)  ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT Markets_For_FK1 FOREIGN KEY (mEmail_FK) REFERENCES Marketing_Company(mEmail) ON DELETE CASCADE,
    CONSTRAINT Markets_For_FK2 FOREIGN KEY (pEmail_FK) REFERENCES Publisher(pEmail)  ON DELETE CASCADE
);
...
DELETE FROM Author
WHERE SSN = "1029334287";

SELECT * FROM Author;

--Delete George RR  Martin
DELETE FROM Author
WHERE aEmail= "George@gmail.com";

SELECT * FROM Author;

--Delete Random house publishers

SELECT * FROM Publisher;

DELETE FROM Publisher
WHERE pEmail= "Accounts@RandomHouse.com";

SELECT * FROM Publisher;

--Delete Tiny Press publishers

DELETE FROM Publisher
WHERE pName= "Tiny Press";

SELECT * FROM Publisher;

--Delete MArtin and MArtin

SELECT * FROM Marketing_Company;

DELETE FROM Marketing_Company
WHERE mEmail = "Accounts@martinsquared.com";
