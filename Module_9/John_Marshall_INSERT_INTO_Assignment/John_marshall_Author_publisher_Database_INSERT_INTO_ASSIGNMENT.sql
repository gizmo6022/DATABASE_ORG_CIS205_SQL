--john marshall 
--Author Publisher Insert Into Assignment
--summer 2 2023
...
(
    ...
    CONSTRAINT Contracts_FK1 FOREIGN KEY (aEmail_FK) REFERENCES Author(aEmail),
    CONSTRAINT Contracts_FK2 FOREIGN KEY (pEmail_FK) REFERENCES Publisher(pEmail)
);
...
(
    ...
    CONSTRAINT Books_FK1 FOREIGN KEY (aEmail_FK) REFERENCES Author(aEmail),
    CONSTRAINT Books_FK2 FOREIGN KEY (pEmail_FK) REFERENCES Publisher(pEmail)
);
...
(
    ...
    CONSTRAINT Markets_For_FK1 FOREIGN KEY (mEmail_FK) REFERENCES Marketing_Company(mEmail),
    CONSTRAINT Markets_For_FK2 FOREIGN KEY (pEmail_FK) REFERENCES Publisher(pEmail)
);
...
("George@gmail.com","Goerge R Martin","877 Main Street, Colarado City, CO","3025554567","1029334287"),
